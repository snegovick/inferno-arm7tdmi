...
fmtinstall(int c, Fmts f)
{
  ...
  bsp_printf("fmtinstall: call _fmtlock\r\n");
	_fmtlock();
  bsp_printf("fmtinstall: _fmtlock done\r\n");
  ...
  bsp_printf("fmtinstall: _fmtunlock\r\n");
	_fmtunlock();
  bsp_printf("fmtinstall: _fmtunlock done\r\n");
	return 0;
}
